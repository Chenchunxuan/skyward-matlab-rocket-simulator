...
settings.OMEGA = 70*pi/180;        %[rad] Minimum Elevation Angle, user input in degrees (ex. 80)
settings.PHI = 200*pi/180;           %[rad] Minimum Azimuth Angle from North Direction, user input in degrees (ex. 90)
...
settings.wind.Day = 105;                         % [d] Maximum Day of the launch
settings.wind.Hour = 13;                         % [h] Minimum Hour of the day
...
settings.wind.Mag = 8;                          % [m/s] Maximum Magnitude
settings.wind.El = 0*pi/180;                     % [rad] Minimum Elevation, user input in degrees (ex. 0)
settings.wind.Az = (20)*pi/180;                   % [rad] Minimum Azimuth, user input in degrees (ex. 90)
